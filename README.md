...
Неофициальный Go-клиент для создания и аннулирования чеков, созданных в [«Мой налог» (Кабинет налогоплательщика НПД)](https://lknpd.nalog.ru).

## Установка

```sh
go get -u github.com/kostromin59/lknpd
```
